 <!-- Fixed navbar -->
    <nav class="navbar navbar-default navbar-starting-top">
      <div class="container">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="https://laracasts.com">Laracarte</a></li>
                <li><a href="https://larajobs.com">Laraveljob</a></li>
                <li><a href="https://laravel-news.com">Laravel News</a></li>
                <li><a href="https://larachart.co">Larachart</a></li>
